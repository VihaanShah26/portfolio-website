...
const projects = [
  {
    ...
    description: `
    We ported Nautilus from 64-bit ARM to a 32-bit Cortex-M33 by crafting a bare-metal GCC toolchain, refactoring all 64-bit data types and atomic primitives, and writing a Thumb‑mode bootloader and linker script tailored to the new memory layout. The nautilus.bin already boots on the MPS2‑AN505 board and runs comfortably within its 4 MB RAM budget; the remaining work is simply wiring the final branch to kernel initialization and adding minimal exception handlers to yield a fully operational embedded aerokernel.
    `,
