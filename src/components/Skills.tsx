...
const skills = [
  ...
  { name: 'TypeScript', level: 'Expert' as const, category: 'languages', icon: <Code className="w-6 h-6" /> },
  ...
  { name: 'Go', level: 'Advanced' as const, category: 'languages', icon: <Code className="w-6 h-6" /> },
  { name: 'C++', level: 'Intermediate' as const, category: 'languages', icon: <Code className="w-6 h-6" /> },
  
  // Frameworks
  { name: 'React', level: 'Expert' as const, category: 'frameworks', icon: <Globe className="w-6 h-6" /> },
  { name: 'Node.js', level: 'Expert' as const, category: 'frameworks', icon: <Server className="w-6 h-6" /> },
  { name: 'Next.js', level: 'Advanced' as const, category: 'frameworks', icon: <Globe className="w-6 h-6" /> },
  { name: 'Express.js', level: 'Advanced' as const, category: 'frameworks', icon: <Server className="w-6 h-6" /> },
  ...
  { name: 'Redis', level: 'Advanced' as const, category: 'tools', icon: <Database className="w-6 h-6" /> },
